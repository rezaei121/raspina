...
class User extends \common\models\BaseModel implements IdentityInterface
{
    ...
    public function rules()
    {
        return [
            ...
            [['old_password','new_password','repeat_password'], 'string', 'min' => 6,'on' => 'changepassword'],
            [['last_name','surname'], 'string', 'max' => 255, 'min' => 3, 'on' => 'account'],
            [['email'], 'email', 'on' => 'account'],
            [['username','email'], 'string', 'max' => 255, 'on' => 'account'],
        ];
    }
