...
class Post extends \common\models\Post
{
    ...
    public function dateValidate()
    {
        ...
        if (Yii::$app->language == 'fa-IR')
        {
            ...
            $newCreatedAt = new \DateTime($this->fromPersian([$date[0], $date[1], $date[2], $this->hour, $this->minute, 0])->toGregorian()->asDateTime());
        } else
        {
    ...
    public function attributeLabels()
    {
        ...
        $parentAttributeLabels['auto_save'] = Yii::t('app', 'Auto Save');
        $parentAttributeLabels['comment_active'] = Yii::t('app', 'Comment Active');
