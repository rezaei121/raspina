            ...
            <?php if($postCategories = $post->categories()): ?>
                <span class="post-detail">
                    ...
                    <?php foreach ($postCategories as $pc): ?>
						<?= Html::a($pc['category']['title'],[0 => '/home/default/index','category' => $pc['category']['id'],'title' => $pc['category']['slug']]) ?> ،
                    <?php endforeach ?>
				</span>
            <?php endif ?>
            <span class="post-detail">
            ...
            <div class="panel-body">
                ...
                <div class="post-text">
                    ...
                    <?php foreach ($postRelated as $related): ?>
                        <?= Html::a($related['title'],[0 => '/post/default/view','id' => $related['id'],'title' => $related['slug']]) ?><br>
                    <?php endforeach ?>
                    <!-- -->
                </div>
            </div>
