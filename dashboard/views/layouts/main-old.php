    ...
    <ul class="top-item pull-right">
        ...
        <a href="<?= Url::base() . '/post/comment'; ?>">
            <li class="<?= $active = ($modules_id == 'comment') ? 'rs-active' : '' ?>">
                ...
                <?php
                    $countNotAccepted = \dashboard\modules\post\models\Comment::getCountNotAccepted();
                    if($countNotAccepted):
                ?>
        ...
        <a href="<?= Url::base() . '/contact'; ?>">
            <li class="<?= $active = ($modules_id == 'contact') ? 'rs-active' : '' ?>">
                ...
                <?php
                    $CountNotVisited = \dashboard\modules\contact\models\Contact::getCountNotVisited();
                    if($CountNotVisited):
                ?>
